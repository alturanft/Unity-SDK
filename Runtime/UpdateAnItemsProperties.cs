...
namespace AlturaNFT
{
    ...
    /// <summary>
    /// Update an Items Properties API
    /// </summary>
    [AddComponentMenu(AlturaConstants.BaseComponentMenu + AlturaConstants.FeatureName_UpdateAnItemsProperties)]
    [ExecuteAlways]
    [HelpURL(AlturaConstants.Docs_PENDING)]
    public class UpdateAnItemsProperties : MonoBehaviour
    {
        ...
        private string RequestUriInit = AlturaConstants.APILink + "/v2/item/update_property";
        ...
        public static UpdateAnItemsProperties Initialize(bool destroyAtEnd = true)
        {
            var _this = new GameObject(AlturaConstants.FeatureName_UpdateAnItemsProperties).AddComponent<UpdateAnItemsProperties>();
        ...
        public UpdateAnItemsProperties SetProperties(string apiKey = null, string address = null, int tokenId = null, string propertyName = null, string propertyValue = null)
        {
            if (apiKey != null)
                this._apiKey = apiKey;
            if (address != null)
        ...
        public UpdateAnItemsProperties OnComplete(UnityAction<Item_model> action)
        {
        ...
        public UpdateAnItemsProperties OnError(UnityAction<string> action)
        {
        ...
        string BuildUrl()
        {
            ...
            if (debugErrorLog)
                Debug.Log("Updating items properties: ");
