...
namespace AlturaNFT
{
    ...
    [AddComponentMenu(AlturaConstants.BaseComponentMenu+AlturaConstants.FeatureName_StorageFiles)]
    [ExecuteAlways]
    [HelpURL(AlturaConstants.Docs_StorageFile)]
    public class Storage_UploadFile : MonoBehaviour
    {
        ...
        private string RequestUriInit = "https://api.alturamft.com/v2/user";
