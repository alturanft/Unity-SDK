...
namespace AlturaNFT
{
    using Internal;
    using Utils;
    [AddComponentMenu(AlturaConstants.BaseComponentMenu+AlturaConstants.FeatureName_StorageMetadata)]
    [ExecuteAlways]
    [HelpURL(AlturaConstants.Docs_StorageMetadata)]
    public class Storage_UploadMetadata : MonoBehaviour
    {
        ...
        public string saveToPath = "Assets/AlturaNFT/";
        ...
        private string RequestUriInit = "https://api.alturanft.com/v1";
