...
namespace AlturaNFT.Internal {
    public class InstallAlturaDependencies : EditorWindow
    {
        ...
        [MenuItem("AlturaNFT/Install Dependencies")]
        public static void ShowWindow()
        {
            var win = GetWindow<InstallAlturaDependencies>("Altura Dependencies");
            SetSize(win);
        }
        ...
        void OnGUI()
        {
            ...
            GUILayout.Label("\n" +
                            " AlturaNFT needs the following packages : \n" +
                            "", EditorStyles.label);
